...
wait.until(expected_conditions.element_to_be_clickable((By.XPATH, '//div[@class="card"]//child::button[@id="j_idt88:j_idt93"]'))).click()
alert = driver.switch_to.alert
#alert.accept()
#ass = wait.until(expected_conditions.visibility_of_element_located((By.ID, "result")))
#assert 'User Clicked : OK' in ass.text
#print("Confirmation passed")
alert.dismiss()
ass = wait.until(expected_conditions.visibility_of_element_located((By.ID, "result")))
assert 'User Clicked : Cancel' in ass.text
